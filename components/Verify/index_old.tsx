...
export const VerifyBlock = () => {
  ...
  const handleVerify = useCallback(async () => {
    ...
    if (verifyResponseJson.status === 200) {
      ...
      setVerified(true);
        ...
        // ✅ Redirecionar para o seu MiniApp após sucesso, direto para o seu MiniApp
         //window.location.href = "https://nft-bnb-20250527.vercel.app/";

         // ✅ Redirecionar para o seu MiniApp após sucesso , apos 2 segundos
       // setTimeout(() => {
       //           window.location.href = "https://nft-bnb-20250527.vercel.app/";
  ...
  return (
    ...
    //<div className="bg-black p-4 rounded-md max-w-md overflow-auto"></div>
    <div className="flex flex-col items-center">
        ...
        <div className="flex flex-col items-center space-y-2">
          {verified ? (
            <>
              ...
              <div className="bg-black p-4 rounded-md max-w-md overflow-auto">
